            ...
            <footer>
                <section className="mainWidth footerBox" >
                    ...
                    <a href="https://github.com/lrudzka" target="_blank">
                        <img src="../img/github.png" alt="my github profile" title="my github profile" style={style1} />
                    </a>
                    <a href="https://www.linkedin.com/in/lucyna-rudzka/" target="_blank">
                        <img src="../img/linkedin.png" alt="my linkedin profile" title="my linkedin profile" style={style2} />
                    </a>
                    </div>
                </section>
            </footer>
